...
public class Arena {
    ...
    public void update() {
        ...
        // Forces players to face each other
        updateFighterFacing();
    ...
    /**
     * Updates the facing direction of both fighters based on their relative X positions.
     */
    private void updateFighterFacing() {
        if (player1.getX() < player2.getX()) {
            player1.setFacingDirection(1);  // Face Right
            player2.setFacingDirection(-1); // Face Left
        } else {
            player1.setFacingDirection(-1); // Face Left
            player2.setFacingDirection(1);  // Face Right
        }
    }
    ...
    public void playerShoot(Fighter player) {
        // Just call shoot(). It will use the facingDirection set by updateFighterFacing().
