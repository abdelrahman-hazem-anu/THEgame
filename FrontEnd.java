...
public class FrontEnd extends Application {
    ...
    private void showMainMenu() {
        ...
        // Create a gradient background for the main menu
        Pane root = new Pane();
        ...
        Label p2Controls = new Label("Controls: ARROWS Move | ENTER Shoot | * Special | 7/8 Switch Weapon");
    ...
    private void setupInputHandling(Scene scene) {
        ...
        scene.setOnKeyPressed(event -> {
            ...
            // Only trigger actions if the key was NOT already held down
            if (!activeKeys.contains(code)) {
                activeKeys.add(code);

                // --- Single Press Actions (Shooting/Special/Switch) ---
                ...
                if (code == KeyCode.MULTIPLY) arena.getPlayer2().useSpecialAbility();
    ...
    private void updateGame() {
        ...
        // Continuous Movement (WASD for P1)
        ...
        // Continuous Movement (Arrows for P2)
    ...
    private void renderGame(GraphicsContext gc) {
        ...
        if (backgroundImage != null) {
            ...
            // Create an epic gradient background
        ...
        // Arena Center Line with glow effect
        ...
        // Fighters with enhanced visuals
