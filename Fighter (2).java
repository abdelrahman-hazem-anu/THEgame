...
public abstract class Fighter {
    ...
    // --- Movement ---
    // Note: Movement sets facing direction, but Arena.update() will correct it 
    // to face the opponent immediately after.
    ...
    /**
     * Shoots horizontally based on the current facingDirection.
     */
    public Projectile shoot() {
        if (!canShoot() || weapon == null) return null;

        double dirX = facingDirection; // Strictly horizontal
        double dirY = 0.0;             // No vertical movement

        // Spawn projectile slightly in front of the fighter
